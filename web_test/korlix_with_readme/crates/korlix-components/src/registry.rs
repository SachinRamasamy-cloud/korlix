...
fn build_registry() -> IndexMap<String, ComponentSchema> {
    ...
    // ── Korlix V2 daily-use component catalogue ─────────────────────
    // These components share the schema-driven generic renderer. Complex
    // behaviour can be progressively specialised without changing syntax.
    let generic_components: &[(&str, ComponentCategory, &str, &str, &[RuntimeFeature])] = &[
        (
            "nav-list",
            ComponentCategory::Navigation,
            "nav",
            "Navigation list",
            &[RuntimeFeature::Router],
        ),
        (
            "nav-item",
            ComponentCategory::Navigation,
        ...
        (
            ...
            ComponentCategory::Form,
            "div",
            "Form label, control and validation container",
            &[RuntimeFeature::Forms],
        ),
        (
            "field-error",
        ...
        (
            ...
            "dialog",
            "Media lightbox",
            &[RuntimeFeature::Overlay, RuntimeFeature::Media],
        ),
        (
            "sheet",
            ComponentCategory::Overlay,
        ...
        (
            ...
            "div",
            "Content carousel",
            &[RuntimeFeature::Media, RuntimeFeature::State],
        ),
        (
            "gallery",
            ComponentCategory::Media,
        ...
        (
            ...
            &[RuntimeFeature::Theme],
        ),
    ];

    for (name, category, tag, description, features) in generic_components {
        ...
        reg!(ComponentSchema {
            ...
            props: vec![
                ...
                prop("size", "string", false, Some("md"), "Component size"),
                prop("disabled", "bool", false, Some("false"), "Disabled state"),
            ],
            slots: vec![slot(None, "Component content")],
            default_classes: vec![format!("kx-{}", name)],
            runtime_features: features.to_vec(),
